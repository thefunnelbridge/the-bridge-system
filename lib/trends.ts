...
export const bridgeTrends: BridgeTrend[] = [
  ...
  {
    id: "beauty-retention-standard",
    industries: ["Salón de belleza / estética grande"],
    title: "La experiencia beauty se gana en confirmación, post atención y recompra",
    externalSignal: "Clientes de belleza y estética comparan rapidez, confianza, resultado esperado y seguimiento posterior.",
    meaning: "Una agenda llena puede esconder fugas si no existen recordatorios, recomendaciones por servicio y retoma de clientas antiguas.",
    recommendedAction: "Crear flujo de confirmación, post servicio y mantención recomendada por tratamiento.",
    suggestedChannel: "WhatsApp + agenda + POS",
    suggestedTool: "Bridge Inbox™ con etiquetas por servicio",
    kpi: "consulta a reserva, no-show y recompra",
    urgency: "Alta",
    impact: "Alto",
  },
  {
    id: "solo-operator-ai-rhythm",
    industries: ["Negocio unipersonal / solopreneur"],
    title: "Los negocios de una persona necesitan ritmo operativo, no más ruido",
    externalSignal: "El solopreneur suele perder crecimiento cuando ventas, entrega, contenido y administración compiten por la misma atención.",
    meaning: "La IA ayuda más cuando prioriza, resume, recuerda y convierte conversaciones en tareas, no cuando agrega herramientas sueltas.",
    recommendedAction: "Definir ritual diario de 3 prioridades, clientes a retomar y bloqueo principal.",
    suggestedChannel: "WhatsApp + Data Room + Worker Today",
    suggestedTool: "Bridge Companion™ como copiloto operativo",
    kpi: "próximas acciones registradas y tareas críticas cerradas",
    urgency: "Media/Alta",
    impact: "Medio/Alto",
  },
  {
...
const generalTrends: BridgeTrend[] = [
  {
    id: "ai-ready-context",
    industries: ["Construcción / Inmobiliaria", "Automotora", "Clínica / salud / estética / dental", "Legal", "Pyme local", "Corredores de propiedades / Brokerage inmobiliario", "Educación", "Municipalidad / institución pública", "Retail / e-commerce", "Logística", "Hotelería / turismo", "Gimnasio / wellness", "Energía / estaciones de servicio / conveniencia", "Salón de belleza / estética grande", "Negocio unipersonal / solopreneur"],
